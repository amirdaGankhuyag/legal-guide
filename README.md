...
5. **LLM-ийн "thinking" токен нь хариултын квотыг иддэг.** `gemini-flash-latest` зэрэг моделууд энгийн асуултад ч токеноо бодоход зарцуулдаг бөгөөд улмаар хариулт дунд өгүүлбэр тасарч, хэрэглэгчид эвдэрсэн текст харагдах тул бодох токен огт зарцуулдаггүй `gemini-3.1-flash-lite` рүү шилжсэн — хариултын хугацаа мөн **4.4с → 1.5с** болж богиноссон.
